...
export default class signUp extends React.Component {
  ...
  validatePhone=()=>{
    ...
    phoneFormat.test(this.state.password)
      ? this.setState({isPhoneNo: true})
      : this.setState({isPhoneNo: false});
  }
  validateEmail = () => {
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        />
        {!this.state.isPhoneNo && (
          <Text style={styles.title}>Enter Valid Phone No</Text>
        )}
        <TouchableOpacity
